...
import static trn.web.rest.TestUtil.createFormattingConversionService;
...
public class SessionResourceIT {
    ...
    public void createSession() throws Exception {
        ...
        assertThat(testSession.getType()).isEqualTo(DEFAULT_TYPE);
        assertThat(testSession.getDesc()).isEqualTo(DEFAULT_DESC);
    }
    ...
    public void updateSession() throws Exception {
        ...
        Session testSession = sessionList.get(sessionList.size() - 1);
        assertThat(testSession.getType()).isEqualTo(UPDATED_TYPE);
        assertThat(testSession.getDesc()).isEqualTo(UPDATED_DESC);
    }
