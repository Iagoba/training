package trn.repository;

import trn.TrainingApp;
import trn.config.Constants;
import trn.config.audit.AuditEventConverter;
import trn.domain.PersistentAuditEvent;
...
import static trn.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
